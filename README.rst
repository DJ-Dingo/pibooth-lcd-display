...
*   **optional** Turn Backlight Off, when Pibooth shutsdown - (**Only necessary when using GPIO 4 or 8 bit mode**)
* 1 NPN transitor (BC547, BC548 or equivalent) Backlight (**Only necessary when using GPIO 4 or 8 bit mode**)
